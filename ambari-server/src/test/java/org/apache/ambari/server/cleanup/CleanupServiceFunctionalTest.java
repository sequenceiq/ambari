...
public class CleanupServiceFunctionalTest {
  ...
  private static Module getTestPersistModule() {
    ...
    persistenceProperties.setProperty(PersistenceUnitProperties.SCHEMA_GENERATION_DATABASE_ACTION, PersistenceUnitProperties.SCHEMA_GENERATION_DROP_AND_CREATE_ACTION);
  ...
  public void testIOCContext() throws Exception {
    ...
    // WHEN
    ChainedCleanupService cleanupService = injector.getInstance(ChainedCleanupService.class);
  ...
  public void testRunCleanup() throws Exception {
    // GIVEN
    ChainedCleanupService cleanupService = injector.getInstance(ChainedCleanupService.class);
    CleanupPolicy cleanupPolicy = CleanupPolicyFactory.timeBasedDeleteCleanupPolicy(10L, 1L);
