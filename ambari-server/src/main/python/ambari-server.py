...
def init_parser_options(parser):
  ...
  parser.add_option('--custom-trust-store', action="store_true", default=None, help="Provide Custom TrustStore", dest="custom_trust_store")
  ...
  parser.add_option('--security-keys-dir', default=None, help="Directory for security keys", dest="security_keys_dir")
  parser.add_option('--api-ssl', default=None, help="Enable SSL for Ambari API [true/false]", dest="api_ssl")
  parser.add_option('--client-api-ssl-port', default=None, help="Client API SSL port", dest="client_api_ssl_port")
