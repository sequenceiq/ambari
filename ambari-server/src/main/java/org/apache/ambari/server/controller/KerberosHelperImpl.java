...
public class KerberosHelperImpl implements KerberosHelper {
      ...
      try {
        ...
        if (configurations != null) {
          for (Map.Entry<String, RecommendationResponse.BlueprintConfigurations> configuration : configurations.entrySet()) {
            ...
            if (propertiesToRemove != null && recommendedConfigPropertyAttributes != null) {
  ...
  /*
   * Recommended property will be added to kerberosConfigurations, if it's not found in existingConfigProperties.
   */
