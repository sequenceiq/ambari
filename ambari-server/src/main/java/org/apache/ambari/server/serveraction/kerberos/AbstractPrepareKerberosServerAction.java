...
public abstract class AbstractPrepareKerberosServerAction extends KerberosServerAction {
  ...
  protected Map<String, Map<String, String>> processServiceComponentHosts(Cluster cluster, KerberosDescriptor kerberosDescriptor, List<ServiceComponentHost> schToProcess,
    ...
    if (!schToProcess.isEmpty()) {
      ...
      try {
        ...
        Map<String, Map<String, String>> kerberosConfigurationsWithoutStackAdvisor = new HashMap<>();
        kerberosConfigurationsWithoutStackAdvisor.putAll(kerberosConfigurations);
        kerberosHelper.applyStackAdvisorUpdates(cluster, services, configurations, kerberosConfigurations,
            propertiesToIgnore, propertiesToRemove, kerberosEnabled);
        return kerberosConfigurationsWithoutStackAdvisor;
      }
      finally {
