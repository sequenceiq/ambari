...
public class HostResourceProvider extends AbstractControllerResourceProvider {
  ...
  public RequestStatusResponse install(final String cluster, final String hostname, Collection<String> startOnlyComponents, final boolean skipFailure)
    ...
    return ((HostComponentResourceProvider) getResourceProvider(Resource.Type.HostComponent)).
        install(cluster, hostname, startOnlyComponents, skipFailure);
  }
