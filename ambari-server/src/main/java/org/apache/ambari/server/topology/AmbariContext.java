...
public class AmbariContext {
  ...
  public RequestStatusResponse installHost(String hostName, String clusterName, Collection<String> startOnlyComponents, boolean skipFailure) {
    try {
      return getHostResourceProvider().install(clusterName, hostName, startOnlyComponents, skipFailure);
    } catch (Exception e) {
