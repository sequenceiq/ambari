...
public class Configuration {
   ...
   * handled directly by ActionScheduler. In case of STAGE_BASED (which is the default) one or more stages are
  ...
  public static final ConfigurationProperty<String> COMMAND_EXECUTION_TYPE = new ConfigurationProperty<>(
    "server.stage.command.execution_type", CommandExecutionType.STAGE_BASED.toString());
