...
@NamedQueries({
    ...
    @NamedQuery(name = "AlertHistoryEntity.removeByClusterAfterDate", query = "DELETE FROM AlertHistoryEntity alertHistory WHERE alertHistory.clusterId= :clusterId AND alertHistory.alertTimestamp >= :afterDate")
})
